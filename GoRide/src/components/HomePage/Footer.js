    ...
    return (
        <footer className="bgd2 py-4">
            <div className="text-center">
                ...
                <span className="block text-sm text-center text-blue-600 tc">
                    © 2024-2025 GoRide™. All Rights Reserved. 
                </span>

                <ul className="flex justify-center mt-3 space-x-5">
                    <li>
                        <a href="#" className="text-blue-600 hover:text-white">
                            <svg className="w-5 h-5" fill="#9e7aff" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <li>
                        <a href="#" className="text-blue-600 hover:text-gray-900">
                            <svg className="w-5 h-5" fill="#9e7aff" viewBox="0 ```javascript
